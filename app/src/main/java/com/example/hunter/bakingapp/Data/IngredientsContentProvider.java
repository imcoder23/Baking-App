...
import static com.example.hunter.bakingapp.Data.IngredientsContract.IngredientsEntry.TABLE_NAME;
...
public class IngredientsContentProvider extends ContentProvider {
    ...
    // --Commented out by Inspection (8/13/2018 11:02 AM):public static final String ACTION_DATA_UPDATED = "com.example.hunter.bakingapp.ACTION_DATA_UPDATED";
    ...
    private IngredientsDbHelper mIngredientAppDbHelper;

    @Override
    public boolean onCreate() {
        Context context = getContext();
        mIngredientAppDbHelper = new IngredientsDbHelper(context);
        return true;
    }
